...
const EventBrowserHeader = () => {
  ...
  return (
    <header className="flex flex-row w-full justify-between items-center fixed z-20 top-0 left-0  pl-5 pr-5 pt-4 bg-primary text-white">
      ...
      <div>
        ...
        >
          ...
          >
            <option hidden>Current Location</option>
